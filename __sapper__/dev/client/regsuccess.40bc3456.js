...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			h1.className = "svelte-17weisd";
			add_location(h1, file, 64, 4, 1110);
			img.src = "rocket.svg";
			img.alt = "rocket";
			img.className = "rocket svelte-17weisd";
			add_location(img, file, 65, 4, 1166);
			span0.className = "svelte-17weisd";
			add_location(span0, file, 66, 4, 1223);
			span1.className = "timer svelte-17weisd";
			add_location(span1, file, 67, 60, 1363);
			span2.className = "svelte-17weisd";
