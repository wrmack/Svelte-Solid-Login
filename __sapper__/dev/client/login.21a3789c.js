...
function create_else_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(input, file$2, 153, 6, 3378);
		},
...
function create_default_slot_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			a0.href = "/register";
			add_location(a0, file$2, 145, 4, 2840);
			a1.href = "https://solid.inrupt.com/get-a-solid-pod";
			a1.rel = "noopener noreferrer";
			a1.target = "_blank";
			a1.className = "link";
			add_location(a1, file$2, 146, 4, 2947);
			span0.className = "svelte-1b9fj8z";
			add_location(span0, file$2, 147, 30, 3113);
			span1.className = "panel-title svelte-1b9fj8z";
			add_location(span1, file$2, 147, 4, 3087);
			button0.type = "button";
			button0.className = "link svelte-1b9fj8z";
			add_location(button0, file$2, 155, 6, 3455);
			button1.type = "submit";
			button1.className = "login svelte-1b9fj8z";
			add_location(button1, file$2, 156, 6, 3561);
			add_location(form, file$2, 149, 5, 3194);
			div0.className = "solid-provider-login-component";
			add_location(div0, file$2, 148, 4, 3144);
			add_location(div1, file$2, 144, 3, 2830);
			div2.className = "panel-body svelte-1b9fj8z";
			add_location(div2, file$2, 143, 2, 2802);
...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h2, file$2, 141, 22, 2750);
			div.className = "welcome svelte-1b9fj8z";
			add_location(div, file$2, 141, 1, 2729);
		},
