import { S as SvelteComponentDev, i as init, s as safe_not_equal, l as create_slot, e as element, t as text, a as space, c as claim_element, b as children, d as claim_text, f as detach, g as attr, h as add_location, j as insert, k as append, o as get_slot_changes, p as get_slot_context, q as transition_in, r as transition_out, m as mount_component, u as destroy_component, E as svg_element, F as listen, n as noop } from './chunk.f8a05be3.js';
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "class", "svelte-67dgs8");
			add_location(h2, file, 59, 30, 1094);
			attr(div0, "class", "progress-bar svelte-67dgs8");
			add_location(div0, file, 59, 59, 1123);
			attr(div1, "class", "panel-header svelte-67dgs8");
			...
			attr(div2, "class", "register-panel svelte-67dgs8");
...
function create_default_slot_1(ctx) {
	var div2, a0, t0, t1, a1, t2, t3, ul, li0, input0, t4, label0, div0, img0, span0, t5, t6, svg0, path0, t7, li1, input1, t8, label1, div1, img1, span1, t9, t10, svg1, path1, t11, div3, button, t12, t13, a2, dispose;
	...
	return {
		...
		h: function hydrate() {
			attr(a0, "href", "https://solid.inrupt.com/how-it-works");
			attr(a0, "target", "_blank");
			attr(a0, "rel", "noopener noreferrer");
			attr(a0, "class", "svelte-103zy7g");
			add_location(a0, file$1, 172, 3, 2866);
			attr(a1, "class", "a-with-spacing svelte-103zy7g");
			attr(a1, "href", "/login");
			add_location(a1, file$1, 173, 3, 3012);
			attr(input0, "type", "radio");
			attr(input0, "name", "providerRadio");
			attr(input0, "id", "radio-0");
			input0.value = "https://inrupt.net/register";
			attr(input0, "class", "svelte-103zy7g");
			add_location(input0, file$1, 176, 5, 3110);
			attr(img0, "src", "inrupt.svg");
			attr(img0, "alt", "Inrupt");
			attr(img0, "class", "svelte-103zy7g");
			add_location(img0, file$1, 179, 7, 3287);
			attr(span0, "class", "label");
			add_location(span0, file$1, 179, 42, 3322);
			attr(div0, "class", "img-group svelte-103zy7g");
			add_location(div0, file$1, 178, 6, 3256);
			...
			add_location(path0, file$1, 182, 7, 3527);
			...
			add_location(svg0, file$1, 181, 6, 3375);
			attr(label0, "for", "radio-0");
			attr(label0, "class", "provider-item svelte-103zy7g");
			add_location(label0, file$1, 177, 5, 3206);
			attr(li0, "class", "svelte-103zy7g");
			add_location(li0, file$1, 175, 4, 3100);
			attr(input1, "type", "radio");
			attr(input1, "name", "providerRadio");
			attr(input1, "id", "radio-1");
			input1.value = "https://solid.community/register";
			attr(input1, "class", "svelte-103zy7g");
			add_location(input1, file$1, 187, 5, 3891);
			attr(img1, "src", "Solid.png");
			attr(img1, "alt", "Solid Community");
			attr(img1, "class", "svelte-103zy7g");
			add_location(img1, file$1, 190, 7, 4073);
			attr(span1, "class", "label");
			add_location(span1, file$1, 190, 50, 4116);
			attr(div1, "class", "img-group svelte-103zy7g");
			add_location(div1, file$1, 189, 6, 4042);
			...
			add_location(path1, file$1, 193, 7, 4330);
			...
			add_location(svg1, file$1, 192, 6, 4178);
			attr(label1, "for", "radio-1");
			attr(label1, "class", "provider-item svelte-103zy7g");
			add_location(label1, file$1, 188, 5, 3992);
			attr(li1, "class", "svelte-103zy7g");
			add_location(li1, file$1, 186, 4, 3881);
			attr(ul, "class", "svelte-103zy7g");
			add_location(ul, file$1, 174, 3, 3091);
			attr(div2, "class", "register-body svelte-103zy7g");
			add_location(div2, file$1, 171, 2, 2835);
			attr(button, "class", "btn-solid svelte-103zy7g");
			add_location(button, file$1, 200, 3, 4725);
			attr(div3, "class", "actions svelte-103zy7g");
			add_location(div3, file$1, 199, 2, 4700);
			attr(a2, "href", "regsuccess");
			add_location(a2, file$1, 202, 2, 4805);
...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "class", "svelte-103zy7g");
			add_location(h2, file$1, 169, 22, 2780);
			attr(div, "class", "welcome svelte-103zy7g");
			add_location(div, file$1, 169, 1, 2759);
		},
		...
		i: function intro(local) {
			if (current) return;
			transition_in(registerpanel.$$.fragment, local);

			current = true;
		},

		o: function outro(local) {
			transition_out(registerpanel.$$.fragment, local);
			current = false;
		},
		...
		d: function destroy(detaching) {
			...
			destroy_component(registerpanel, detaching);
		}
	};
}
