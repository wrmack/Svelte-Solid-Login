import { S as SvelteComponentDev, i as init, s as safe_not_equal, l as create_slot, e as element, t as text, c as claim_element, b as children, d as claim_text, f as detach, h as add_location, g as attr, j as insert, k as append, o as get_slot_changes, p as get_slot_context, q as transition_in, r as transition_out, a as space, E as svg_element, F as listen, w as set_data, n as noop, G as run_all, H as binding_callbacks, I as createEventDispatcher, m as mount_component, u as destroy_component, D as onMount, v as globals, J as prevent_default, B as group_outros, C as check_outros } from './chunk.f8a05be3.js';
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(div, "class", "login-panel svelte-1o585o2");
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "id", "placeholder-text");
			attr(div0, "class", "svelte-1e6kb6v");
			add_location(div0, file$1, 232, 12, 5521);
			attr(div1, "id", "enter");
			attr(div1, "class", "svelte-1e6kb6v");
			add_location(div1, file$1, 231, 8, 5492);
			attr(span0, "id", "divider");
			attr(span0, "class", "svelte-1e6kb6v");
			...
			attr(div2, "class", "arrow svelte-1e6kb6v");
			attr(div2, "aria-hidden", "true");
			add_location(div2, file$1, 236, 12, 5663);
			attr(div3, "id", "arrow-container");
			attr(div3, "class", "svelte-1e6kb6v");
			add_location(div3, file$1, 234, 8, 5585);
			attr(div4, "class", "select-box svelte-1e6kb6v");
			add_location(div4, file$1, 230, 4, 5459);
			attr(span1, "class", "helper svelte-1e6kb6v");
			add_location(span1, file$1, 245, 12, 6433);
			attr(img0, "class", "logo svelte-1e6kb6v");
			attr(img0, "src", img0_src_value = providers[0].image);
			attr(img0, "alt", "first provider");
			add_location(img0, file$1, 245, 40, 6461);
			attr(span2, "class", "providerName svelte-1e6kb6v");
			add_location(span2, file$1, 245, 107, 6528);
			attr(div5, "class", "option svelte-1e6kb6v");
			attr(div5, "id", "0");
			add_location(div5, file$1, 244, 8, 6361);
			attr(span3, "class", "helper svelte-1e6kb6v");
			add_location(span3, file$1, 248, 12, 6678);
			attr(img1, "class", "logo svelte-1e6kb6v");
			attr(img1, "src", img1_src_value = providers[1].image);
			attr(img1, "alt", "second provider");
			add_location(img1, file$1, 248, 40, 6706);
			attr(span4, "class", "providerName svelte-1e6kb6v");
			add_location(span4, file$1, 248, 108, 6774);
			attr(div6, "class", "option svelte-1e6kb6v");
			attr(div6, "id", "1");
			add_location(div6, file$1, 247, 8, 6606);
			attr(div7, "class", "provider-list svelte-1e6kb6v");
			attr(div7, "id", "dropdown");
			attr(div7, "tabindex", "0");
			add_location(div7, file$1, 243, 4, 6228);
			attr(div8, "class", "solid-provider-select svelte-1e6kb6v");
...
function instance$1($$self, $$props, $$invalidate) {
	...
	function div7_binding($$value) {
		binding_callbacks[$$value ? 'unshift' : 'push'](() => {
			$$invalidate('displayProv', displayProv = $$value);
		});
	}
...
function create_else_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(input, "name", "idp");
			attr(input, "placeholder", "WebID");
			attr(input, "class", "svelte-1b9fj8z");
			add_location(input, file$2, 161, 6, 3598);
		},
...
function create_default_slot_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(a0, "class", "ids-link-filled ids-link-filled--primary");
			attr(a0, "href", "/register");
			add_location(a0, file$2, 153, 4, 3060);
			attr(a1, "href", "https://solid.inrupt.com/get-a-solid-pod");
			attr(a1, "rel", "noopener noreferrer");
			attr(a1, "target", "_blank");
			attr(a1, "class", "link");
			add_location(a1, file$2, 154, 4, 3167);
			attr(span0, "class", "svelte-1b9fj8z");
			add_location(span0, file$2, 155, 30, 3333);
			attr(span1, "class", "panel-title svelte-1b9fj8z");
			add_location(span1, file$2, 155, 4, 3307);
			attr(button0, "type", "button");
			attr(button0, "class", "link svelte-1b9fj8z");
			add_location(button0, file$2, 163, 6, 3675);
			attr(button1, "type", "submit");
			attr(button1, "class", "login svelte-1b9fj8z");
			add_location(button1, file$2, 164, 6, 3781);
			add_location(form, file$2, 157, 5, 3414);
			attr(div0, "class", "solid-provider-login-component");
			add_location(div0, file$2, 156, 4, 3364);
			add_location(div1, file$2, 152, 3, 3050);
			attr(div2, "class", "panel-body svelte-1b9fj8z");
			add_location(div2, file$2, 151, 2, 3022);
...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "class", "svelte-1b9fj8z");
			add_location(h2, file$2, 149, 22, 2970);
			attr(div, "class", "welcome svelte-1b9fj8z");
			add_location(div, file$2, 149, 1, 2949);
		},
		...
		i: function intro(local) {
			if (current) return;
			transition_in(loginpanel.$$.fragment, local);

			current = true;
		},

		o: function outro(local) {
			transition_out(loginpanel.$$.fragment, local);
			current = false;
		},
		...
		d: function destroy(detaching) {
			...
			destroy_component(loginpanel, detaching);
		}
	};
}
...
function create_fragment$3(ctx) {
	...
	return {
		...
		i: function intro(local) {
			if (current) return;
			transition_in(authenticateuser.$$.fragment, local);

			current = true;
		},

		o: function outro(local) {
			transition_out(authenticateuser.$$.fragment, local);
			current = false;
		},
		...
		d: function destroy(detaching) {
			...
			destroy_component(authenticateuser, detaching);
		}
	};
}
