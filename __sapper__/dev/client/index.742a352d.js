...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			div.className = "card svelte-1m4doad";
...
function create_default_slot_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			span.className = "svelte-163kza3";
			add_location(span, file$1, 65, 13, 1106);
			h3.className = "svelte-163kza3";
...
function create_fragment$2(ctx) {
	...
	return {
		...
		i: function intro(local) {
			if (current) return;
			displayhome.$$.fragment.i(local);

			current = true;
		},

		o: function outro(local) {
			displayhome.$$.fragment.o(local);
			current = false;
		},
